...
test.describe("[E2E] [UI] [Customers] [Details]", () => {
  ...
  test(
    ...
    async ({ page, homeUIService, customersListUIService, customersApiService, customerDetailsPage }) => {
      ...
      await customersListUIService.openDetailsPage(createdCustomer.email);
